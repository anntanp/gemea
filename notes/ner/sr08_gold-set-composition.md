...
| **Unknown-era records (45)** | Original target was 0; entered as artifact of Leichenpredigt/Einblattdruck genre oversampling pulling records whose year could not be resolved. Cannot be evaluated per-era. Decision needed: remove, keep as unstratified spot-check, or reduce to 25 as proposed in [sr08_evaluation-design.md §7](sr08_evaluation-design.md). |
