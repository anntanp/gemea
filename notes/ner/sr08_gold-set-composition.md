...
| **Unknown-era records (45)** | **Resolved 2026-03-30: kept as unstratified spot-check.** Reducing to 25 (as proposed in sr08_evaluation-design.md §7) or removing was considered but deferred — annotation cost of resampling outweighs the benefit. Cannot be evaluated per-era; exclude from per-era F1 reporting. See sr08_evaluation-design.md §8 for full rationale. |
