...
- **1700–1800** is a transition: long-form conventions persist into the early 18th century (32.0% long overall), then decline from 1750 onward. Author placement mixed — some pre-1750 author-before-title, some ISBD-conformant. The length decline is at least partly attributable to the displacement of Latin scholarly production — structurally long *dissertatio*- and *tractatus*-style titles — by German: Wittmann (1999, p. 122) documents the share of Latin *Meßnovitäten* falling from 27.7% (1740) to 14.25% (1770) to 3.97% (1800). The quantitative title-length evidence is from `DF_DE_TITLES` itself; no source makes the token-length claim directly.
