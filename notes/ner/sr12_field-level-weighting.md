...
- **External**: once SR-08 gold set exists, measure NER F1 for models trained at different score cutoffs and select the elbow.

The external method is preferred — it directly measures annotation quality impact rather than proxy precision metrics. It requires SR-08 to be completed first.
...
- SR-08 completion (for external calibration of tier boundary)
