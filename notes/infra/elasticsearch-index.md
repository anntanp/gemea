...
- **Compound splitting**: consider adding `decompounder` token filter with a domain dictionary from DDB type/genre vocabulary (see `https://github.com/anntanp/bibner-werk/blob/main/notes/ner/nlp-tasks.md`)
